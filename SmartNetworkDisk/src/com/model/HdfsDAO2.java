...
public class HdfsDAO2 {
    ...
    public HdfsDAO2(Configuration conf) {
        this(HDFS, conf);
    }

    public HdfsDAO2(String hdfs, Configuration conf) {
        this.hdfsPath = hdfs;
        this.conf = conf;
    }
    ...
    public static void main(String[] args) throws IOException {
        JobConf conf = config();
        HdfsDAO2 hdfs = new HdfsDAO2(conf);
        //hdfs.mkdirs("/Tom");
    ...
    public  static JobConf config(){
        JobConf conf = new JobConf(HdfsDAO2.class);
